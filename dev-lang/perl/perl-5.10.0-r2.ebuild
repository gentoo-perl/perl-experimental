...
PDEPEND=">=app-admin/perl-cleaner-1.03
		!build? (
			...
			>=perl-core/CPANPLUS-0.84
			>=perl-core/CPAN-1.92.05
			>=perl-core/Digest-SHA-5.45
			>=perl-core/Encode-2.23
			>=perl-core/ExtUtils-MakeMaker-6.42
			>=perl-core/Module-Build-0.28.08
			>=perl-core/Module-CoreList-2.15
...
#EOF
	...
	src_remove_dual_scripts ptar ptardiff
	# - perl-core/Digest-SHA
	src_remove_dual_scripts shasum
	# - perl-core/CPAN
	src_remove_dual_scripts cpan
	# - perl-core/CPANPLUS
	src_remove_dual_scripts cpanp cpan2dist cpanp-run-perl
	# - perl-core/Encode
	src_remove_dual_scripts enc2xs piconv
	# - perl-core/ExtUtils-MakeMaker
	src_remove_dual_scripts instmodsh
	# - perl-core/Module-Build
	src_remove_dual_scripts config_data
	# - perl-core/Module-CoreList
	src_remove_dual_scripts corelist
	# - perl-core/PodParser

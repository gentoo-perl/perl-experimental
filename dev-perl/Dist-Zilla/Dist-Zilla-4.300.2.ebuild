...
# Config::MVP::Section 2.200.1
depend Config-MVP 2.200.1 # ^^
depend Config-MVP-Reader-INI 2.0.0
# depend Data-Dumper # CORE
depend Data-Section 0.4.0
depend DateTime 0.44 # 0.440.0
depend-virtual Digest-MD5
depend-virtual Encode
depend-virtual ExtUtils-MakeMaker
depend-virtual ExtUtils-Manifest 1.540.0
...
depend Moose 0.92 # 0.920.0
depend Moose-Autobox 0.10 # 0.100.0
...
depend Params-Util
depend Path-Class
depend Perl-PrereqScanner 1.5.0
depend Perl-Version
depend Pod-Eventual 0.091480 # 0.91.480
...
depend autodie
# depend-virtual base # CORE
depend namespace-autoclean
depend-virtual parent
# depend-virtual strict # CORE
depend-virtual version
# depend-virtual warnings # CORE

hard_conflict Dist-Zilla-Plugin-MetaNoIndex

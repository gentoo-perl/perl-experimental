...
perl_meta_runtime() {
	...
	# Module::Pluggable 4.7 ( 4.700.0 )
	echo \>=virtual/perl-Module-Pluggable-4.700.0
	# Moose 1.03 ( 1.30.0 )
	...
	# Try::Tiny 0.17 ( 0.170.0 )
	echo \>=dev-perl/Try-Tiny-0.170.0
	# JSON::MaybeXS 1.000000 ( 1.0.0 )
	echo \>=dev-perl/JSON-MaybeXS-1.0.0
	# Stream::Buffered
	echo dev-perl/Stream-Buffered
	# Hash::MultiValue
	echo dev-perl/Hash-MultiValue
	# Plack::Request::Upload
	echo dev-perl/Plack
	# CGI::Struct
	echo dev-perl/CGI-Struct
	...
	echo dev-perl/Plack
	# Plack::Middleware::FixMissingBodyInRedirect 0.09 ( 0.90.0 )
	echo \>=dev-perl/Plack-Middleware-FixMissingBodyInRedirect-0.90.0
	# Plack::Middleware::MethodOverride
	echo dev-perl/Plack-Middleware-MethodOverride
	# Plack::Middleware::RemoveRedundantBody 0.03 ( 0.30.0 )
	echo \>=dev-perl/Plack-Middleware-RemoveRedundantBody-0.30.0
	# URI 1.36 ( 1.360.0 )

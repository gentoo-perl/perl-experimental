...
perl_meta_runtime() {
	# CPAN::Perl::Releases 0.58 ( 0.580.0 )
	echo \>=dev-perl/CPAN-Perl-Releases-0.580.0
	# Capture::Tiny 0.18 ( 0.180.0 )
	echo \>=dev-perl/Capture-Tiny-0.180.0
	# Devel::PatchPerl 0.70 ( 0.700.0 )
	echo \>=dev-perl/Devel-PatchPerl-0.700.0
